...
def plot_image_big(image, i):
    ...
    img.save('./result/' + str(count) + '/' + str(i) + '.jpg')


def plot_images(content_image, style_image, mixed_image, epoch):
    ...
    fig.savefig('./result/' + str(epoch) + '.jpg')
    plt.close()
...
def style_transfer(content_filename, style_filename, count_,
    ...
    global count
    count = count_
    content_image = load_image(content_filename, max_size=400)

    style_image = load_image(style_filename, max_size=400)
    ...
    for i in range(num_iterations):
        ...
        if (i % 60 == 0) or (i == num_iterations - 1):
            ...
            #             epoch=i)
            plot_image_big(mixed_image, int(i / 60) + 1)

    print()
    print("Final image:")
    plot_image_big(mixed_image, 10)
